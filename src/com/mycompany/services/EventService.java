...
public class EventService {
    ...
    public ArrayList<Event> getAll() {
        ...
        cr = new ConnectionRequest();
        cr.setUrl(Statics.BASE_URL + "/mobile/event");
    ...
    public int manage(Event event, boolean isEdit, boolean imageEdited) {
        ...
        if (isEdit) {
            cr.setUrl(Statics.BASE_URL + "/mobile/event/edit");
            cr.addArgumentNoEncoding("id", String.valueOf(event.getId()));
        } else {
            cr.setUrl(Statics.BASE_URL + "/mobile/event/add");
        }
    ...
    public int delete(int eventId) {
        cr = new ConnectionRequest();
        cr.setUrl(Statics.BASE_URL + "/mobile/event/delete");
        cr.setHttpMethod("POST");
