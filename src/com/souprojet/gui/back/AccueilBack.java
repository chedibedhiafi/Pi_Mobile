package com.souprojet.gui.back;
...
public class AccueilBack extends Form {
    ...
    private Button makeEventsButton() {
        ...
        button.addActionListener(action -> new com.souprojet.gui.back.event.ShowAll(this).show());
        return button;
    }
    private Button makeReservationsButton() {
        ...
        button.setUIID("buttonMenu");
        //button.setMaterialIcon(FontImage.MATERIAL_BOOKMARK);
        button.addActionListener(action -> new com.souprojet.gui.back.reservation.ShowAll(this).show());
        return button;
    }
